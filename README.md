...
- v0.24.0 includes the following changes.
  - fix [#356](https://github.com/mcci-catena/Catena-Arduino-Platform/issues/356): add support for storing uplink interval to FRAM (v0.24.0-pre1)
