...
#define GUID_HW_MODEL_4916_BASE(f)		\
...
#define GUID_HW_MODEL_4917_BASE(f)		\
	MCCIADK_GUID_GEN_INIT(f,  0xd9d35ffd, 0x1859, 0x4686, 0x90, 0x0c, 0xdd, 0x7f, 0xd5, 0x94, 0x18, 0x86)

// {d5bb121d-f5e6-4755-b510-f8723c5dc9b9}
#define GUID_HW_MODEL_4931_BASE(f)		\
	MCCIADK_GUID_GEN_INIT(f,  0xd5bb121d, 0xf5e6, 0x4755, 0xb5, 0x10, 0xf8, 0x72, 0x3c, 0x5d, 0xc9, 0xb9)

// {3626d5de-f251-4466-be24-d4c767cf1812}
#define GUID_HW_MODEL_4933_BASE(f)		\
	MCCIADK_GUID_GEN_INIT(f,  0x3626d5de, 0xf251, 0x4466, 0xbe, 0x24, 0xd4, 0xc7, 0x67, 0xcf, 0x18, 0x12)

// {95821499-37b7-40e8-98fd-0462dca5d30b}
#define GUID_HW_CATENA_5220_BASE(f)		\
	MCCIADK_GUID_GEN_INIT(f,  0x95821499, 0x37b7, 0x40e8, 0x98, 0xfd, 0x04, 0x62, 0xdc, 0xa5, 0xd3, 0x0b)

// {929bdae7-63a4-4537-978e-00812bed69b5}
#define GUID_HW_CATENA_5230_BASE(f)		\
	MCCIADK_GUID_GEN_INIT(f,  0x929bdae7, 0x63a4, 0x4537, 0x97, 0x8e, 0x00, 0x81, 0x2b, 0xed, 0x69, 0xb5)
