/* Catena48xx.h	Fri Oct 13 2017 15:19:30 chwon */
...
Function:
	class Catena48xx: CatenaBase Platform to represent a Catena 48xx
	(4801, etc.)
...
#ifndef _CATENA48xx_H_		/* prevent multiple includes */
#define _CATENA48xx_H_
...
class Catena48xx : public CatenaStm32L0LoRa
	{
public:
	...
	Catena48xx(const Catena48xx&) = delete;
	Catena48xx& operator=(const Catena48xx&) = delete;
	Catena48xx(const Catena48xx&&) = delete;
	Catena48xx& operator=(const Catena48xx&&) = delete;
...
/*
|| The LoRaWAN class for the Catena 48xx. Assumes The Things Network
*/
class Catena48xx::LoRaWAN : public CatenaStm32L0LoRa::LoRaWAN
	{
public:
	...
	*/
	...
	bool begin(Catena48xx *pParent);
        Catena48xx *getCatena() const { return this->m_pCatena; };
