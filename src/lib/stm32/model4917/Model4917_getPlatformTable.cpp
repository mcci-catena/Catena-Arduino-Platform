...
Module:  Model4917_getPlatformTable.cpp

Function:
        Model4917::getPlatformTable()
...
const CATENA_PLATFORM gkPlatformModel4917 =
	{
	Guid: GUID_HW_MODEL_4917_BASE(WIRE),
	pParent: &gkPlatformModel4917,
	PlatformFlags:
		CatenaBase::fHasLoRa |
...
const CATENA_PLATFORM (* const Model4917::vPlatforms[]) =
	{
	// entry 0 is the default
	&gkPlatformModel4917,
	};

const size_t Model4917::nvPlatforms = sizeof(Model4917::vPlatforms) / sizeof(Model4917::vPlatforms[0]);

/*

Name:	Model4917::getPlatformTable()
...
Definition:
	public: virtual
		void Model4917::getPlatformTable(
