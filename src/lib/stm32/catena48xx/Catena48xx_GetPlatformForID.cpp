/* Catena48xx_GetPlatformForID.cpp	Fri Oct 13 2017 15:19:30 chwon */

/*

Module:  Catena48xx_GetPlatformForID.cpp

Function:
	Catena48xx::GetPlatformForID()
...
const CATENA_PLATFORM (* const Catena48xx::vPlatforms[]) =
	{
...
const size_t Catena48xx::nvPlatforms = sizeof(Catena48xx::vPlatforms) / sizeof(Catena48xx::vPlatforms[0]);

/*

Name:	Catena48xx::GetPlatformForID()
...
Catena48xx::GetPlatformForID(
	...
	MCCIADK_GUID_WIRE PlatformGuid;
        ...
        gLog.printf(gLog.kAlways, "Catena48xx::GetPlatformForID entered\n");
...
/**** end of Catena48xx_GetPlatformForID.cpp ****/
