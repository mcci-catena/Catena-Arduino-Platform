/* Catena48xx_begin.cpp	Wed Dec 06 2017 15:31:37 chwon */

/*

Module:  Catena48xx_begin.cpp
...
Name:	Catena48xx::begin()

Function:
	Set up all the well-known board peripherals.

Definition:
	bool Catena48xx::begin();

Description:
	Issues begin() for all the Catena48xx things.
