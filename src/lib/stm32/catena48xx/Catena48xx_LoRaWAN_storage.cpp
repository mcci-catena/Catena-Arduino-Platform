/* Catena48xx_LoRaWAN_storage.cpp	Fri Oct 13 2017 15:19:30 chwon */

/*

Module:  Catena48xx_LoRaWAN_storage.cpp
...
Name:	Catena48xx::LoRaWAN::GetAbpProvisioningInfo()
...
Definition:
	public: virtual bool
		Catena48xx::LoRaWAN::GetAbpProvisioningInfo(
		        Catena48xx::LoRaWAN::AbpProvisioningInfo *pInfo
		        ) override;
...
Catena48xx::LoRaWAN::GetAbpProvisioningInfo(
        ...
        {
        Catena48xx * const pCatena = this->m_pCatena;
...
Name:	Catena48xx::LoRaWAN::GetOtaaProvisioningInfo()
...
Definition:
	public: virtual bool
		Catena48xx::LoRaWAN::GetOtaaProvisioningInfo(
		        Catena48xx::LoRaWAN::OtaaProvisioningInfo *pInfo
		        ) override;
...
Catena48xx::LoRaWAN::ProvisioningStyle
Catena48xx::LoRaWAN::GetProvisioningStyle(
	void
	)
	{
        Catena48xx * const pCatena = this->m_pCatena;
...
void
Catena48xx::LoRaWAN::NetSaveFCntUp(
	uint32_t uFCntUp
	)
	{
        Catena48xx * const pCatena = this->m_pCatena;
...
void
Catena48xx::LoRaWAN::NetSaveFCntDown(
	uint32_t uFCntDown
	)
	{
        Catena48xx * const pCatena = this->m_pCatena;
...
void
Catena48xx::LoRaWAN::NetSaveSessionInfo(
...
/**** end of Catena48xx_LoRaWAN_storage.cpp ****/
