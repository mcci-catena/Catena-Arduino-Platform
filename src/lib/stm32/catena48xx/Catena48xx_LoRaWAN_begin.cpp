/* Catena48xx_LoRaWAN_begin.cpp	Fri Oct 13 2017 15:19:30 chwon */

/*

Module:  Catena48xx_LoRaWAN_begin.cpp

Function:
	Catena48xx::LoRaWAN::begin()
...
Name:	Catena48xx::LoRaWAN::begin()

Function:
	Record linkage to main Catena object and set up LoRaWAN.

Definition:
	bool Catena48xx::LoRaWAN::begin(
		Catena48xx *pParent
		);
...
Catena48xx::LoRaWAN::begin(
	...
	{
        static const char FUNCTION[] = "Catena48xx::LoRaWAN::begin";
...
/**** end of Catena48xx_LoRaWAN_begin.cpp ****/
