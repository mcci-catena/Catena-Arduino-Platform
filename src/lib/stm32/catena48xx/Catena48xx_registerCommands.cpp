/* Catena48xx_registerCommands.cpp	Fri Oct 13 2017 15:19:30 chwon */

/*

Module:  Catena48xx_registerCommands.cpp

Function:
	Catena48xx::registerCommands()
...
doConfigure(
	...
	{
	Catena48xx * const pCatena = static_cast<Catena48xx *>(pContext);
	uint8_t databuf[16];
...
/**** end of Catena48xx_registerCommands.cpp ****/
