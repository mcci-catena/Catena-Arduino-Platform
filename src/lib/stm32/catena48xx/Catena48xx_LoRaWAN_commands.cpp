/* Catena48xx_LoRaWAN_commands.cpp	Fri Oct 13 2017 15:19:30 chwon */

/*

Module:  Catena48xx_LoRaWAN_commands.cpp

Function:
	The command engine for lorawan commands on the Catena 48xx.
...
Name:	Catena48xx::LoRaWAN::addCommands()

Function:
	Add the lorawan commands to the Catena command table.

Definition:
	private: bool Catena48xx::LoRaWAN::addCommands();
...
bool
Catena48xx::LoRaWAN::addCommands()
	{
	gLog.printf(gLog.kAlways, "Catena48xx::LoRaWAN::addCommands(): adding\n");
...
doConfigure(
	...
	{
	Catena48xx::LoRaWAN * const pLoRaWAN =
		static_cast<Catena48xx::LoRaWAN *>(pContext);
	Catena48xx * const pCatena = pLoRaWAN->getCatena();
	uint8_t databuf[16];
...
/**** end of Catena48xx_LoRaWAN_commands.cpp ****/
