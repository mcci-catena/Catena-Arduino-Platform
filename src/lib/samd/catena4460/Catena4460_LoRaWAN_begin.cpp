/* Catena4460_LoRaWAN_begin.cpp	Sun Mar 12 2017 19:31:15 tmm */

/*

Module:  Catena4460_LoRaWAN_begin.cpp

Function:
	Catena4460::LoRaWAN::begin()
...
Name:	Catena4460::LoRaWAN::begin()

Function:
	Record linkage to main Catena object and set up LoRaWAN.

Definition:
	bool Catena4460::LoRaWAN::begin(
		Catena4460 *pParent
		);
...
Catena4460::LoRaWAN::begin(
	...
	{
        static const char FUNCTION[] = "Catena4460::LoRaWAN::begin";
