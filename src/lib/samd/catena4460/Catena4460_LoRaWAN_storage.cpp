/* Catena4460_LoRaWAN_storage.cpp	Fri Mar 17 2017 22:49:16 tmm */

/*

Module:  Catena4460_LoRaWAN_storage.cpp
...
Name:	Catena4460::LoRaWAN::GetAbpProvisioningInfo()
...
Definition:
	public: virtual bool
		Catena4460::LoRaWAN::GetAbpProvisioningInfo(
		        Catena4460::LoRaWAN::AbpProvisioningInfo *pInfo
		        ) override;
...
Catena4460::LoRaWAN::GetAbpProvisioningInfo(
        ...
        {
        Catena4460 * const pCatena = this->m_pCatena;
...
Name:	Catena4460::LoRaWAN::GetOtaaProvisioningInfo()
...
Definition:
	public: virtual bool
		Catena4460::LoRaWAN::GetOtaaProvisioningInfo(
		        Catena4460::LoRaWAN::OtaaProvisioningInfo *pInfo
		        ) override;
...
Catena4460::LoRaWAN::ProvisioningStyle
Catena4460::LoRaWAN::GetProvisioningStyle(
	void
	)
	{
        Catena4460 * const pCatena = this->m_pCatena;
...
void
Catena4460::LoRaWAN::NetSaveFCntUp(
	uint32_t uFCntUp
	)
	{
        Catena4460 * const pCatena = this->m_pCatena;
...
void
Catena4460::LoRaWAN::NetSaveFCntDown(
	uint32_t uFCntDown
	)
	{
        Catena4460 * const pCatena = this->m_pCatena;
...
void 
Catena4460::LoRaWAN::NetSaveSessionInfo(
