/* Catena4470_begin.cpp	Sun Mar 12 2017 19:19:28 tmm */

/*

Module:  Catena4470_begin.cpp
...
Name:	Catena4470::begin()

Function:
	Set up all the well-known board peripherals.

Definition:
	bool Catena4470::begin();

Description:
	Issues begin() for all the Catena4470 things.
...
bool Catena4470::begin()
	{
        delay(2000);
        gLog.printf(gLog.kAlways, "+Catena4470::begin()\n");
