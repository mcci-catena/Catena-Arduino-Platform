/* Catena4470_LoRaWAN_storage.cpp	Fri Mar 17 2017 22:49:16 tmm */

/*

Module:  Catena4470_LoRaWAN_storage.cpp
...
Name:	Catena4470::LoRaWAN::GetAbpProvisioningInfo()
...
Definition:
	public: virtual bool
		Catena4470::LoRaWAN::GetAbpProvisioningInfo(
		        Catena4470::LoRaWAN::AbpProvisioningInfo *pInfo
		        ) override;
...
Catena4470::LoRaWAN::GetAbpProvisioningInfo(
        ...
        {
        Catena4470 * const pCatena = this->m_pCatena;
...
Name:	Catena4470::LoRaWAN::GetOtaaProvisioningInfo()
...
Definition:
	public: virtual bool
		Catena4470::LoRaWAN::GetOtaaProvisioningInfo(
		        Catena4470::LoRaWAN::OtaaProvisioningInfo *pInfo
		        ) override;
...
Catena4470::LoRaWAN::ProvisioningStyle
Catena4470::LoRaWAN::GetProvisioningStyle(
	void
	)
	{
        Catena4470 * const pCatena = this->m_pCatena;
...
void
Catena4470::LoRaWAN::NetSaveFCntUp(
	uint32_t uFCntUp
	)
	{
        Catena4470 * const pCatena = this->m_pCatena;
...
void
Catena4470::LoRaWAN::NetSaveFCntDown(
	uint32_t uFCntDown
	)
	{
        Catena4470 * const pCatena = this->m_pCatena;
...
void 
Catena4470::LoRaWAN::NetSaveSessionInfo(
