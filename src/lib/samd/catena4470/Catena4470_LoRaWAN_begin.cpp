/* Catena4470_LoRaWAN_begin.cpp	Sun Mar 12 2017 19:31:15 tmm */

/*

Module:  Catena4470_LoRaWAN_begin.cpp

Function:
	Catena4470::LoRaWAN::begin()
...
Name:	Catena4470::LoRaWAN::begin()

Function:
	Record linkage to main Catena object and set up LoRaWAN.

Definition:
	bool Catena4470::LoRaWAN::begin(
		Catena4470 *pParent
		);
...
Catena4470::LoRaWAN::begin(
	...
	{
        static const char FUNCTION[] = "Catena4470::LoRaWAN::begin";
