...
class Catena4470 : public CatenaFeatherM0LoRa
	{
public:
...
/*
|| The LoRaWAN class for the Catena 4470. Assumes The Things Network
*/
class Catena4470::LoRaWAN : public CatenaFeatherM0LoRa::LoRaWAN
	{
public:
	...
	*/
	...
	bool begin(Catena4470 *pParent);
        Catena4470 *getCatena() const { return this->m_pCatena; };
